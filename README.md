...
Consulte `docs/knowledge_base/INDEX.md` antes de trabalhar em conceitos ou decisões do produto. Documentos em `official/` têm precedência sobre referências complementares e não devem ser alterados sem autorização explícita.

## Estado atual e roadmap

O projeto está na etapa de fundação do repositório. As etapas seguintes estão registradas em `docs/04_roadmap.md`; ainda não existem coleta, scoring, benchmark, banco de dados, interface ou integração com IA.
