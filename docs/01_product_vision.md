...
- equipes de due diligence e research;
- profissionais de risco, compliance e operações;
- gestores e analistas de ativos digitais e RWAs;
- comitês de investimento e avaliadores institucionais.

## Diferenciais

- evidência antes da conclusão;
- rastreabilidade de fonte, versão, extração e validação;
- separação entre dado, hipótese, conclusão e recomendação;
- scores calculados por regras, não por modelos generativos;
- arquitetura local-first com núcleo independente de IA.
