...
| TS-004 | Asset Registry | Implementar identidade, classificação e estado dos ativos, separando candidatos e entidades em investigação. | `APPROVED` | Vermelho — versionamento explicitamente autorizado | TS-003A versionada | Auditoria concluída e aprovação do fundador concedida | — | Criar e enviar o primeiro commit da TS-004. |
| TS-005 | Source Registry | Definir e implementar o cadastro de fontes e sua governança. | `PLANNED` | A definir | TS-004 auditada e aprovada | Pendente | — | Planejar após auditoria e aprovação da TS-004. |
